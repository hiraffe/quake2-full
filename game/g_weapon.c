...
// hira: proximity think function -from proximity mine tutorial by Chris Hilton
...
=================
*/
static void Trap_Capture(edict_t* ent)
{
	vec3_t		origin;
	int			mod;
